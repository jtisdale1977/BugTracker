...
namespace BugTracker.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        public async Task<ActionResult> DemoLogin(string demoRole, string returnUrl)
        {
            var email = "";
            ...
            var result = await SignInManager.PasswordSignInAsync(email, "Abc&123!", false, shouldLockout: false);
            switch (result)
            {
        ...
        [HttpPost]
        public ActionResult UserManagement([Bind(Include = "Id,FirstName,LastName,DisplayName,Email,UserName,PhoneNumber")] ApplicationUser user)
        {
            if (ModelState.IsValid)
            {
